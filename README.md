...
It enables independent parallel sequences for efficient PRNGs (such as [BlastCircuit™](https://github.com/ghostproxies/blastcircuit) and [RecoilFuse™](https://github.com/ghostproxies/recoilfuse)).
